...
- Added Formatting linked translations [more](https://github.com/aissat/quick_localization#linked-translations)
- Updated `plural()` function, with arguments [more](https://github.com/aissat/quick_localization#linked-translations)
  ```dart
...
- Added support Custom assets loaders [Easy Localization Loader](https://github.com/aissat/quick_localization_loader).
...
- Added Code generation of localization files.
  ...
  ```cmd
  $ flutter pub run quick_localization:generate -h
  ...
  - generate the json string static keys in a dart class
    ...
    ```cmd
    flutter pub run quick_localization:generate  -f keys -o locale_keys.g.dart
    ```
  ...
  - generate the json Loader in a dart class
    ...
    ```cmd
    flutter pub run quick_localization:generate
    ```
...
- fixed many issues
- added Unite test
- Customization AssetLoader localizations `assetLoader` for more details see [custom assetLoader](https://github.com/aissat/quick_localization/blob/dev/example/lib/custom_asset_loader.dart)
- added `fallbackLocale` as optional
- Hiding `EasyLocalizationProvider`
- refactor and update approach localization for more details see [example:](https://github.com/aissat/quick_localization/tree/master/example)
