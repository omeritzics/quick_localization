  ...
  group('Asset Loader - Linked Translation Files', () {
    group('RootBundleAssetLoader with linked files', () {
      test('should load single linked file', () async {
        ...
        final result = await controller.loadTranslationData(
          const Locale('en', 'linked'),
        );
        ...
        expect(
          result['app']['errors']['server_error'],
          'Internal server error',
        );
        expect(
          result['app']['errors']['invalid_input'],
      ...
      test('should load multiple linked files', () async {
        ...
        expect(
          result['multiple']['errors']['not_found'],
          'Multiple resource not found',
        );
        expect(
          result['multiple']['validation']['required'],
          'Multiple field is required',
        );
      });
      ...
      test('should load nested linked files', () async {
        ...
        expect(
          result['nested']['module']['messages']['welcome'],
          'Welcome to our app',
        );
        expect(
          result['nested']['module']['messages']['goodbye'],
          'Thank you for using our app',
        );
        expect(
          result['nested']['module']['messages']['info'],
          'This is a nested message file',
        );
      });
      ...
      test('should load deeply nested linked files', () async {
        ...
        expect(
          result['deep_nested']['level2']['level2_value'],
          'This is level 2',
        );
        expect(
          result['deep_nested']['level2']['final_message'],
          'Deep nesting works!',
        );
      });
    ...
    group('Edge cases for linked files', () {
      test('should work with useOnlyLangCode setting', () async {
        ...
        expect(
          (result['hats'] as Map<String, dynamic>).containsKey('zero'),
          true,
        );
      });
    });
